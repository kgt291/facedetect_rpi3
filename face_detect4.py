...
def facedetect(i):
    ...
    cmdstr='static/image_'+str(i)+'.jpg'
    image = cv2.imread(cmdstr)
    ...
    equ = sess.run(net.accuracy, feed_dict={net.net['input']: [image], net.target:[label], net.dropout:1.0})
